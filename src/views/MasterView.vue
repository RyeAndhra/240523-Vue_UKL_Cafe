        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-2 col-md-8 col-sm-12">
                    ...
                    <p class="wow fadeInUp" data-wow-delay="1.0s">Lorem ipsum dolor sit amet, consectetuer adipiscing
                        elit, sed
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="wow fadeInUp col-md-3 col-sm-5" data-wow-delay="0.3s">
                    <img src="frontend/images/about-img.jpg" class="img-responsive" alt="About">
                ...
                <div class="wow fadeInUp col-md-5 col-sm-7" data-wow-delay="0.5s">
                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li>
                                <img src="frontend/images/slide-img1.jpg" alt="Flexslider">
                            </li>
                            <li>
                                <img src="frontend/images/slide-img2.jpg" alt="Flexslider">
                            </li>
                            <li>
                                <img src="frontend/images/slide-img3.jpg" alt="Flexslider">
                            </li>
                ...
                <div class="wow fadeInUp col-md-4 col-sm-12" data-wow-delay="0.9s">
                    <h2>Fine Dining</h2>
                    <p>Steak House is free HTML website template for everyone. Please inform your friends about Tooplate
                        site.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-2 col-md-8 col-sm-12">
                    ...
                    <p class="wow fadeInUp" data-wow-delay="0.8s">Lorem ipsum dolor sit amet, consectetuer adipiscing
                        elit, sed
                        diam nonummy nibh euismod tincidunt ut laoreet. Dolore magna aliquam erat volutpat.</p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="media wow fadeInUp" data-wow-delay="0.6s">
                        <div class="media-object pull-left">
                            <img src="frontend/images/gallery-img1.jpg" class="img-responsive" alt="Food Menu">
                    ...
                    <div class="media wow fadeInUp" data-wow-delay="0.9s">
                        <div class="media-object pull-left">
                            <img src="frontend/images/gallery-img2.jpg" class="img-responsive" alt="Food Menu">
                    ...
                    <div class="media wow fadeInUp" data-wow-delay="1.2s">
                        <div class="media-object pull-left">
                            <img src="frontend/images/gallery-img3.jpg" class="img-responsive" alt="Food Menu">
                            <span class="menu-price">$24</span>
                        </div>
                        <div class="media-body">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="media wow fadeInUp" data-wow-delay="1s">
                        <div class="media-object pull-left">
                            <img src="frontend/images/gallery-img4.jpg" class="img-responsive" alt="Food Menu">
                    ...
                    <div class="media wow fadeInUp" data-wow-delay="1.3s">
                        <div class="media-object pull-left">
                            <img src="frontend/images/gallery-img5.jpg" class="img-responsive" alt="Food Menu">
                    ...
                    <div class="media wow fadeInUp" data-wow-delay="1.6s">
                        <div class="media-object pull-left">
                            <img src="frontend/images/gallery-img6.jpg" class="img-responsive" alt="Food Menu">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="team-thumb">
                        <img src="frontend/images/chef1.jpg" class="img-responsive" alt="Team">
                        <div class="team-des">
                            <h3>Sandar</h3>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-thumb">
                        <img src="frontend/images/chef2.jpg" class="img-responsive" alt="Team">
                        <div class="team-des">
                            <h3>Candy</h3>
                            <h4>Co-Founder</h4>
                            <ul class="social-icon">
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="team-thumb">
                        <img src="frontend/images/chef3.jpg" class="img-responsive" alt="Team">
                        <div class="team-des">
                            <h3>Mama</h3>
                            <h4>Senior Chef</h4>
                            <ul class="social-icon">
                ...
                <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="0.3s">
                    <h2>Our Taste</h2>
                    <p>Fusce lobortis quis nisl nec facilisis. Donec fringilla ipsum arcu, quis maximus est molestie
                        eget. Nunc
                        ullamcorper suscipit neque, ac malesuada purus molestie non. Phasellus sollicitudin urna sed
                        ultrices
                        dictum.</p>
                </div>
                ...
                <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="0.6s">
                    <h2>Our Service</h2>
                    <p>Maecenas dictum cursus dui, quis mattis eros ultricies sed. Maecenas ligula nulla, dictum eu
                        cursus id,
                        semper in orci. Fusce vel nisi hendrerit justo viverra vehicula in nec nunc. Curabitur blandit
                        fringilla
                        quam.</p>
                </div>
                            ...
                            <div class="iso-box-wrapper col4-iso-box">
                                ...
                                <div class="iso-box breakfast pizza lunch col-md-4 col-sm-6">
                                    <div class="gallery-thumb">
                                        <a href="frontend/images/gallery-img1.jpg" data-lightbox-gallery="food-gallery">
                                            <img src="frontend/images/gallery-img1.jpg" class="fluid-img" alt="Gallery">
                                ...
                                <div class="iso-box breakfast lunch dinner col-md-4 col-sm-6">
                                    <div class="gallery-thumb">
                                        <a href="frontend/images/gallery-img2.jpg" data-lightbox-gallery="food-gallery">
                                            <img src="frontend/images/gallery-img2.jpg" class="fluid-img" alt="Gallery">
                                            <div class="gallery-overlay">
                                                <div class="gallery-item">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                ...
                                <div class="iso-box dinner col-md-4 col-sm-6">
                                    <div class="gallery-thumb">
                                        <a href="frontend/images/gallery-img3.jpg" data-lightbox-gallery="food-gallery">
                                            <img src="frontend/images/gallery-img3.jpg" class="fluid-img" alt="Gallery">
                                            <div class="gallery-overlay">
                                                <div class="gallery-item">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                ...
                                <div class="iso-box breakfast col-md-4 col-sm-6">
                                    <div class="gallery-thumb">
                                        <a href="frontend/images/gallery-img4.jpg" data-lightbox-gallery="food-gallery">
                                            <img src="frontend/images/gallery-img4.jpg" class="fluid-img" alt="Gallery">
                                            <div class="gallery-overlay">
                                                <div class="gallery-item">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                ...
                                <div class="iso-box lunch col-md-4 col-sm-6">
                                    <div class="gallery-thumb">
                                        <a href="frontend/images/gallery-img5.jpg" data-lightbox-gallery="food-gallery">
                                            <img src="frontend/images/gallery-img5.jpg" class="fluid-img" alt="Gallery">
                                            <div class="gallery-overlay">
                                                <div class="gallery-item">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                ...
                                <div class="iso-box pizza lunch col-md-4 col-sm-6">
                                    <div class="gallery-thumb">
                                        <a href="frontend/images/gallery-img6.jpg" data-lightbox-gallery="food-gallery">
                                            <img src="frontend/images/gallery-img6.jpg" class="fluid-img" alt="Gallery">
                                            <div class="gallery-overlay">
                                                <div class="gallery-item">
                                                    <i class="fa fa-search"></i>
                                                </div>
